...
import {HeaderSlider, Loader, ProductList} from '../../Components'
...
const HomePage = ()=>{
    ...
    const productStatus = useSelector(state =>state.product.productsStatus);
    ...
    //Dảo--trộn sản phẩm
    const ramdomListProduct = useMemo(()=>{
        const tempProducts = [];
                ...
                <div className="container">
                    <div className="categories py-5">
                        <div className="categories-item">
                            ...
                            :   <ProductList products = {ramdomListProduct}/>
                            }
                        </div>
